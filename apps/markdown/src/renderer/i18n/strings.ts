export const strings = {
  ...
  vi: {
    loading: 'Đang mở…',
    loadError: 'Mở tệp không thành công',
    saving: 'Đang lưu…',
    savedOk: 'Đã lưu',
    saveFailed: 'Lưu không thành công',
    unsaved: 'Chưa lưu',
    placeholder: 'Bắt đầu nhập…',
    styleParagraph: 'Văn bản',
    styleH1: 'Tiêu đề 1',
    styleH2: 'Tiêu đề 2',
    styleH3: 'Tiêu đề 3',
    styleH4: 'Tiêu đề 4',
    ...
    slashNoResults: 'Không có kết quả',
    ...
    blockAddBelow: 'Thêm khối phía dưới',
    blockDuplicate: 'Nhân bản',
    blockMoveUp: 'Chuyển lên',
    blockMoveDown: 'Chuyển xuống',
    blockDelete: 'Xóa',
    blockGripHint: 'Kéo để di chuyển, bấm để mở menu',
    aiUnknownError: 'Yêu cầu AI không thành công, vui lòng thử lại',
    aiTimeoutError: 'Phản hồi của AI đã hết thời gian chờ',
    ...
    aiTidyPrompt:
      'Dọn dẹp định dạng của tài liệu — sửa cấp độ tiêu đề, thống nhất định dạng danh sách, bỏ các chỗ in đậm và in nghiêng không cần thiết, và dọn các dòng trống thừa. Chỉ điều chỉnh định dạng — không thay đổi nội dung văn bản',
    aiNewChat: 'Cuộc trò chuyện mới',
    aiCollapsePanel: 'Thu gọn bảng',
    aiEmptyTitle: 'Hỏi về tài liệu này',
    aiEmptyBody: 'Soạn thảo, viết lại, tóm tắt, dịch hoặc tạo một tài liệu từ đầu',
    aiQuickDraft: 'Soạn giúp tôi một tài liệu',
    aiQuickDraftPrompt: 'Hãy soạn giúp tôi một tài liệu về chủ đề: ',
    aiQuickPolish: 'Trau chuốt tài liệu',
    aiQuickPolishPrompt:
      'Trau chuốt toàn bộ tài liệu: sửa ngữ pháp, thống nhất cách dùng từ, cải thiện khả năng đọc; giữ nguyên ý nghĩa và cấu trúc.',
    aiComposerPlaceholder: 'Nhờ AI viết hoặc chỉnh sửa tài liệu…',
    ...
    aiTurnLimit: 'Đã đạt giới hạn số bước mỗi lượt chạy — gửi chỉ dẫn khác để tiếp tục.',
    aiUndelivered: 'Chưa gửi — tin nhắn này không có tác dụng',
    aiRetry: 'Thử lại',
    aiCopyReplyTitle: 'Sao chép phản hồi',
    aiRegenerateTitle: 'Tạo lại',
    aiSnapshotsTitle: 'Ảnh chụp',
    aiRollback: 'Khôi phục',
    aiToolReadDoc: 'Đọc dàn ý tài liệu',
    aiToolReadBlocks: 'Đọc nội dung',
    aiToolInsert: 'Chèn nội dung',
    aiToolInsertDone: 'Đã chèn {n} khối',
    aiToolReplace: 'Thay nội dung',
