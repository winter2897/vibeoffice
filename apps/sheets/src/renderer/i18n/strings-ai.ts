...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiAideAccount: 'Aide 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 Aide 账号）',
  ...
  ja: {
    ...
    aiAideAccount: 'Aide アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には Aide アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginAide: 'Aide にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
  ...
  ko: {
    ...
    aiAideAccount: 'Aide 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 Aide 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginAide: 'Aide 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
  ...
  fr: {
    ...
    aiAideAccount: 'Compte Aide',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte Aide)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginAide: 'Se connecter à Aide',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  ru: {
    ...
    aiAideAccount: 'Учётная запись Aide',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись Aide)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginAide: 'Войти в Aide',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  nl: {
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een Aide-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginAide: 'Aanmelden bij Aide',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
  ...
  he: {
    ...
    aiAideAccount: 'חשבון Aide',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון Aide)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiLoginAide: 'כניסה ל-Aide',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
  ...
  vi: {
    ...
    aiEmptyBuildTitle: 'Để AI tạo bảng tính này cho bạn',
    aiEmptyBuildBody: 'Mô tả bảng, dữ liệu hoặc biểu đồ bạn cần — AI sẽ tạo ngay tại chỗ.',
    aiGskLoginBtn: 'Đăng nhập vào Aide',
    aiUndelivered: 'Chưa gửi được — tin nhắn này không có tác dụng',
    aiRetry: 'Thử lại',
    aiOpenAssistant: 'Mở trợ lý AI',
    aiCheckBtn: 'Kiểm tra AI',
    aiCheckPrompt:
      'Kiểm tra trang tính này để tìm vấn đề: 1) lỗi công thức (#REF!, #DIV/0!, v.v.), vùng không bao phủ hết dữ liệu, hàng tổng thiếu cột; 2) số và văn bản lẫn lộn trong cùng một cột, định dạng ngày không nhất quán, giá trị ngoại lai rõ rệt và hàng trùng lặp; 3) tổng không khớp với các hàng chi tiết, cột phần trăm không cộng đủ 100%. Liệt kê các vấn đề tìm thấy và đề xuất cách khắc phục',
    aiAnalyzeBtn: 'Phân tích AI',
    aiAnalyzePrompt:
      'Phân tích dữ liệu trong trang tính này và tóm tắt các phát hiện chính, xu hướng và bất thường',
    ...
    aiEmptyTitle: 'Hỏi AI về bảng tính này',
    aiEmptyBodyLine1: 'Mô tả một thay đổi hoặc đặt câu hỏi về dữ liệu.',
    aiStarterSummarizeLabel: 'Tóm tắt trang tính này',
    aiStarterSummarizePrompt:
      'Đọc dữ liệu trên trang tính đang hoạt động và tóm tắt nội dung của nó.',
    aiStarterTotalsLabel: 'Thêm hàng tổng',
    aiStarterTotalsPrompt:
      'Thêm một hàng Tổng bên dưới dữ liệu hiện có, dùng công thức SUM cho mỗi cột số.',
    aiStarterFormulasLabel: 'Kiểm tra công thức',
    aiStarterFormulasPrompt:
      'Đọc các công thức trên trang tính đang hoạt động và chỉ ra bất cứ điều gì có vẻ sai hoặc thiếu chắc chắn.',
    ...
    aiUndoTitle: 'Hoàn tác thay đổi AI này (giống ⌘Z)',
    aiUndo: 'Hoàn tác',
    aiPreviewAria: 'Xem trước thay đổi',
    aiProposedChanges: 'Thay đổi đề xuất',
    aiChangeStructure: 'Cấu trúc',
    aiChangeFormat: 'Định dạng',
    aiChangeSheet: 'Trang tính',
    aiMoreCells: 'và {count} ô khác',
    aiCellEmpty: 'trống',
    aiRemoveAttachment: 'Xóa tệp đính kèm',
    aiAttachTitle: 'Đính kèm tệp cục bộ (hoặc kéo thả vào bảng)',
    aiComposerPlaceholder: 'Yêu cầu AI phân tích hoặc cập nhật bảng tính này…',
    aiHintIdle: 'Enter để gửi',
    aiHintBusy: 'Esc để dừng',
    aiHintIdleTitle: 'Enter để gửi · Shift+Enter để xuống dòng',
    aiSend: 'Gửi',
    aiStop: 'Dừng',
    aiInstructionAria: 'Hướng dẫn AI',
    aiFileTooltip:
      'SHA-256 {sha}\nLưu chỉ ghi lại các mục đã chỉnh sửa; mọi thứ khác được giữ nguyên.',
    aiFileMeta: '{sheets} trang tính · {entries} mục',
    aiAideAccount: 'Tài khoản Aide',
    aiAccountChecking: 'Đang kiểm tra…',
    aiLoggedIn: 'Đã đăng nhập',
    aiLoggedInAs: 'Đã đăng nhập: {email}',
    aiNotLoggedIn: 'Chưa đăng nhập (tính năng AI cần có tài khoản Aide)',
    aiWaitingBrowserLogin: 'Đang chờ đăng nhập trên trình duyệt…',
    aiLoginAide: 'Đăng nhập vào Aide',
    aiModel: 'Mô hình',
    aiCancel: 'Hủy',
    aiSave: 'Lưu',
    aiUnknownError: 'Lỗi không xác định',
    aiTimeoutError:
      'Yêu cầu AI đã hết thời gian chờ: không nhận được phản hồi từ mạng nên đã dừng chạy. Kiểm tra kết nối và thử lại',
    aiCreditsExhausted:
      'Tín dụng Aide của bạn đã hết. Truy cập genspark.ai/pricing để nạp thêm rồi thử lại',
    aiToolWorkbookContext: 'Đọc thông tin bảng tính',
    aiToolReadRange: 'Đọc vùng',
    aiToolReadRangeOf: 'Đọc vùng {range}',
    ...
    aiToolImageAttachment: 'Tệp đính kèm hình ảnh {name}',
  ...
  'zh-TW': {
    ...
    aiAideAccount: 'Aide 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 Aide 帳號）',
