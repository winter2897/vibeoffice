...
export const strings = {
  ...
  vi: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Các dự án được tạo trên web bằng Genspark AI. Việc chỉnh sửa tiếp tục trong trình duyệt — bấm vào một dự án bất kỳ để mở.',
    ...
    loggedInGenspark: 'Đã đăng nhập Genspark',
    ...
    loginNetworkError: 'Không thể kết nối đến Genspark — kiểm tra mạng hoặc cài đặt proxy',
    ...
    onbBody2:
      'GenOffice vẫn đang trong giai đoạn alpha. Tham gia nhóm chat trên GenTeam để chia sẻ phản hồi và cùng định hình những gì sắp tới.',
    onbCredits: 'Người đóng góp tích cực nhận **1.000+ credit Genspark**',
