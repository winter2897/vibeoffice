...
/**
 * VibeOffice unified shell: ONE Electron app, ONE BrowserWindow, hosting the
...
// run silently quits and forwards its argv to the running installed VibeOffice.
...
// The product rename from "AI Office" to VibeOffice changed the userData path; migrate old user data once
if (app.isPackaged) {
...
// Aide credit-usage page opened from the account menu's credits row.
...
const tMain = createI18n({
  zh: {
    ...
    pdfDocxLoginMsg: '导出为 Word 需要登录 Aide 账号。',
    pdfDocxLoginDetail: '点击“登录”将打开浏览器完成授权，完成后请重新点击导出。',
    pdfDocxBtnLogin: '登录',
    pdfDocxConfirmMsg: '将此 PDF 上传到 Aide 云端转换为 Word？',
    ...
    pdfDocxNoCliMsg: '无法登录 Aide：缺少必需组件（gsk），请重新安装应用。',
  ...
  en: {
    ...
    pdfDocxLoginMsg: 'Exporting as Word requires signing in to Aide.',
    pdfDocxLoginDetail:
      'Clicking “Sign In” opens your browser to authorize; once done, click Export again.',
    pdfDocxBtnLogin: 'Sign In',
    pdfDocxConfirmMsg: 'Upload this PDF to Aide cloud and convert it to Word?',
    ...
    pdfDocxNoCliMsg:
      'Cannot sign in to Aide: a required component (gsk) is missing. Please reinstall the app.',
  ...
  ja: {
    ...
    pdfDocxLoginMsg: 'Word への書き出しには Aide へのログインが必要です。',
    pdfDocxLoginDetail:
      '「ログイン」をクリックするとブラウザで認証します。完了後、もう一度書き出しを実行してください。',
    pdfDocxBtnLogin: 'ログイン',
    pdfDocxConfirmMsg: 'この PDF を Aide クラウドにアップロードして Word に変換しますか？',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Aide にサインインできません：必要なコンポーネント（gsk）が見つかりません。アプリを再インストールしてください。',
  ...
  ko: {
    ...
    pdfDocxLoginMsg: 'Word로 내보내려면 Aide 로그인이 필요합니다.',
    pdfDocxLoginDetail:
      '“로그인”을 클릭하면 브라우저에서 인증합니다. 완료 후 내보내기를 다시 클릭하세요.',
    pdfDocxBtnLogin: '로그인',
    pdfDocxConfirmMsg: '이 PDF를 Aide 클라우드에 업로드하여 Word로 변환할까요?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Aide에 로그인할 수 없습니다. 필수 구성 요소(gsk)가 없습니다. 앱을 다시 설치해 주세요.',
  ...
  fr: {
    ...
    pdfDocxLoginMsg: "L'export en Word nécessite une connexion à Aide.",
    pdfDocxLoginDetail:
      "Cliquez sur « Se connecter » pour autoriser dans le navigateur, puis relancez l'export.",
    pdfDocxBtnLogin: 'Se connecter',
    pdfDocxConfirmMsg: 'Téléverser ce PDF vers le cloud Aide pour le convertir en Word ?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      "Connexion à Aide impossible : un composant requis (gsk) est manquant. Veuillez réinstaller l'application.",
  ...
  de: {
    ...
    pdfDocxLoginMsg: 'Für den Word-Export ist eine Anmeldung bei Aide erforderlich.',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: 'Dieses PDF in die Aide-Cloud hochladen und in Word konvertieren?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Anmeldung bei Aide nicht möglich: Eine erforderliche Komponente (gsk) fehlt. Bitte installieren Sie die App neu.',
  ...
  es: {
    ...
    pdfDocxLoginMsg: 'Para exportar como Word es necesario iniciar sesión en Aide.',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: '¿Subir este PDF a la nube de Aide para convertirlo a Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'No se puede iniciar sesión en Aide: falta un componente necesario (gsk). Reinstale la aplicación.',
  ...
  th: {
    ...
    pdfDocxLoginMsg: 'การส่งออกเป็น Word ต้องเข้าสู่ระบบ Aide',
    pdfDocxLoginDetail:
      'คลิก “เข้าสู่ระบบ” เพื่อเปิดเบราว์เซอร์ยืนยันตัวตน เสร็จแล้วให้คลิกส่งออกอีกครั้ง',
    pdfDocxBtnLogin: 'เข้าสู่ระบบ',
    pdfDocxConfirmMsg: 'อัปโหลด PDF นี้ไปยังคลาวด์ Aide เพื่อแปลงเป็น Word หรือไม่?',
    ...
    pdfDocxNoCliMsg:
      'ไม่สามารถลงชื่อเข้าใช้ Aide ได้: ไม่พบคอมโพเนนต์ที่จำเป็น (gsk) โปรดติดตั้งแอปใหม่',
  ...
  id: {
    ...
    pdfDocxLoginMsg: 'Ekspor sebagai Word memerlukan login ke Aide.',
    pdfDocxLoginDetail:
      'Klik “Masuk” untuk membuka browser dan memberi otorisasi; setelah selesai, klik Ekspor lagi.',
    pdfDocxBtnLogin: 'Masuk',
    pdfDocxConfirmMsg: 'Unggah PDF ini ke cloud Aide untuk dikonversi ke Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Tidak dapat masuk ke Aide: komponen yang diperlukan (gsk) tidak ditemukan. Silakan instal ulang aplikasi.',
  ...
  ru: {
    ...
    pdfDocxLoginMsg: 'Для экспорта в Word требуется вход в Aide.',
    pdfDocxLoginDetail:
      'Нажмите «Войти», чтобы авторизоваться в браузере, затем снова запустите экспорт.',
    pdfDocxBtnLogin: 'Войти',
    pdfDocxConfirmMsg: 'Загрузить этот PDF в облако Aide и конвертировать в Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Не удаётся войти в Aide: отсутствует необходимый компонент (gsk). Переустановите приложение.',
  ...
  ar: {
    ...
    pdfDocxLoginMsg: 'يتطلب التصدير كملف Word تسجيل الدخول إلى Aide.',
    pdfDocxLoginDetail:
      'انقر على «تسجيل الدخول» لفتح المتصفح وإتمام التفويض، ثم انقر على التصدير مرة أخرى.',
    pdfDocxBtnLogin: 'تسجيل الدخول',
    pdfDocxConfirmMsg: 'رفع هذا الـ PDF إلى سحابة Aide وتحويله إلى Word؟',
    ...
    pdfDocxNoCliMsg:
      'تعذّر تسجيل الدخول إلى Aide: المكوّن المطلوب (gsk) مفقود. يُرجى إعادة تثبيت التطبيق.',
  ...
  pt: {
    ...
    menuExportDocx: 'Exportar como Word…',
    pdfDocxLoginMsg: 'Exportar como Word requer login no Aide.',
    pdfDocxLoginDetail:
      'Clique em “Entrar” para autorizar no navegador; depois, clique em Exportar novamente.',
    pdfDocxBtnLogin: 'Entrar',
    pdfDocxConfirmMsg: 'Enviar este PDF para a nuvem do Aide e convertê-lo em Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Não é possível iniciar sessão no Aide: falta um componente necessário (gsk). Reinstale o aplicativo.',
  ...
  it: {
    ...
    pdfDocxLoginMsg: 'Per esportare come Word è necessario accedere a Aide.',
    pdfDocxLoginDetail:
      'Fai clic su “Accedi” per autorizzare nel browser; al termine, fai di nuovo clic su Esporta.',
    pdfDocxBtnLogin: 'Accedi',
    pdfDocxConfirmMsg: 'Caricare questo PDF sul cloud Aide e convertirlo in Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      "Impossibile accedere a Aide: manca un componente necessario (gsk). Reinstallare l'app.",
  ...
  pl: {
    ...
    pdfDocxLoginMsg: 'Eksport do formatu Word wymaga zalogowania do Aide.',
    pdfDocxLoginDetail:
      'Kliknij „Zaloguj się”, aby autoryzować w przeglądarce; po zakończeniu kliknij Eksportuj ponownie.',
    pdfDocxBtnLogin: 'Zaloguj się',
    pdfDocxConfirmMsg: 'Przesłać ten PDF do chmury Aide i przekonwertować na Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Nie można zalogować się do Aide: brakuje wymaganego komponentu (gsk). Zainstaluj aplikację ponownie.',
  ...
  nl: {
    ...
    pdfDocxLoginMsg: 'Exporteren als Word vereist inloggen bij Aide.',
    pdfDocxLoginDetail:
      'Klik op “Inloggen” om in de browser te autoriseren; klik daarna opnieuw op Exporteren.',
    pdfDocxBtnLogin: 'Inloggen',
    pdfDocxConfirmMsg: 'Deze PDF uploaden naar de Aide-cloud en converteren naar Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Kan niet inloggen bij Aide: een vereist onderdeel (gsk) ontbreekt. Installeer de app opnieuw.',
  ...
  ms: {
    ...
    pdfDocxLoginMsg: 'Eksport sebagai Word memerlukan log masuk ke Aide.',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: 'Muat naik PDF ini ke awan Aide untuk ditukar kepada Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Tidak dapat log masuk ke Aide: komponen yang diperlukan (gsk) tiada. Sila pasang semula aplikasi.',
  ...
  he: {
    ...
    pdfDocxLoginMsg: 'ייצוא כ-Word דורש התחברות ל-Aide.',
    pdfDocxLoginDetail: 'לחיצה על ”התחברות” תפתח את הדפדפן לאישור; בסיום, לחצו שוב על ייצוא.',
    pdfDocxBtnLogin: 'התחברות',
    pdfDocxConfirmMsg: 'להעלות את ה-PDF לענן של Aide ולהמיר אותו ל-Word?',
    ...
    pdfDocxNoCliMsg: 'לא ניתן להתחבר ל-Aide: רכיב נדרש (gsk) חסר. נא להתקין מחדש את האפליקציה.',
  ...
  hi: {
    ...
    pdfDocxLoginMsg: 'Word के रूप में निर्यात करने के लिए Aide में लॉगिन आवश्यक है।',
    pdfDocxLoginDetail:
      '“लॉगिन” पर क्लिक करने से ब्राउज़र में प्राधिकरण खुलेगा; पूरा होने पर फिर से निर्यात पर क्लिक करें।',
    pdfDocxBtnLogin: 'लॉगिन',
    pdfDocxConfirmMsg: 'इस PDF को Aide क्लाउड पर अपलोड करके Word में बदलें?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Aide में साइन इन नहीं किया जा सकता: आवश्यक घटक (gsk) मौजूद नहीं है। कृपया ऐप को फिर से इंस्टॉल करें।',
  ...
  vi: {
    ...
    untitledDeck: 'Bài trình bày chưa có tiêu đề',
    ...
    errExists: 'Đã tồn tại tệp với tên này',
    errRenameFailed: 'Đổi tên không thành công',
    ...
    pdfDocxLoginMsg: 'Xuất dưới dạng Word yêu cầu đăng nhập vào Aide.',
    pdfDocxLoginDetail:
      'Nhấp "Đăng nhập" sẽ mở trình duyệt để xác thực; sau khi hoàn tất, nhấp Xuất lại.',
    pdfDocxBtnLogin: 'Đăng nhập',
    pdfDocxConfirmMsg: 'Tải PDF này lên đám mây Aide và chuyển đổi sang Word?',
    pdfDocxConfirmDetail:
      'Việc chuyển đổi tốn 5 credit. Tệp sẽ được tải lên để xử lý trên đám mây.',
    pdfDocxConfirmBalance: 'Số dư hiện tại: {balance} credit.',
    pdfDocxBtnConvert: 'Tiếp tục',
    btnCancel: 'Hủy',
    pdfDocxFailedMsg: 'Xuất dưới dạng Word không thành công',
    pdfDocxNoCliMsg:
      'Không thể đăng nhập vào Aide: thiếu thành phần bắt buộc (gsk). Vui lòng cài đặt lại ứng dụng.',
    pdfDocxBusyMsg: 'Đang có một tiến trình xuất Word khác. Vui lòng đợi tiến trình đó hoàn tất.',
    dlgPickSaveDir: 'Chọn vị trí lưu mặc định',
    errSaveDirUnusable:
      'Thư mục đã chọn không cho phép ghi nên không thể dùng làm vị trí lưu mặc định',
  },
  'zh-TW': {
    menuFile: '檔案',
    menuSectionNew: '新增',
    ...
    pdfDocxLoginMsg: '匯出為 Word 需要登入 Aide 帳號。',
    pdfDocxLoginDetail: '點擊「登入」將開啟瀏覽器完成授權，完成後請重新點擊匯出。',
    pdfDocxBtnLogin: '登入',
    pdfDocxConfirmMsg: '將此 PDF 上傳到 Aide 雲端轉換為 Word？',
    ...
    pdfDocxNoCliMsg: '無法登入 Aide：缺少必要元件（gsk），請重新安裝應用程式。',
...
function registerHomeIpc(): void {
  // signed-in means VibeOffice's own device-code login; the shared gsk CLI key
...
async function installMainProcessProxy(): Promise<void> {
  ...
  if (!proxyUrl) {
    try {
      ...
      // Aide LLM proxy and the gsk CLI actually target
