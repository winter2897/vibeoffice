...
const tMain = createI18n({
  ...
  vi: {
    ...
    pdfDocxLoginMsg: 'Xuất dưới dạng Word yêu cầu đăng nhập vào Genspark.',
    pdfDocxLoginDetail:
      'Nhấp "Đăng nhập" sẽ mở trình duyệt để xác thực; sau khi hoàn tất, nhấp Xuất lại.',
    pdfDocxBtnLogin: 'Đăng nhập',
    pdfDocxConfirmMsg: 'Tải PDF này lên đám mây Genspark và chuyển đổi sang Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Không thể đăng nhập vào Genspark: thiếu thành phần bắt buộc (gsk). Vui lòng cài đặt lại ứng dụng.',
