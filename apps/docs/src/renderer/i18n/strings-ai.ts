...
export const aiStrings = defineStrings({
  ...
  vi: {
    aiEmptyDraftTitle: 'Để AI soạn thảo tài liệu này giúp bạn',
    aiEmptyDraftBody1: 'Mô tả chủ đề và ý chính, hoặc dán tài liệu tham khảo;',
    aiEmptyDraftBody2: 'AI viết ngay bản nháp đầu tiên vào trang.',
    aiStarterSummarize: 'Tóm tắt ý chính của tài liệu này',
    aiStarterPolishAll: 'Trau chuốt toàn bộ tài liệu cho văn phong chuyên nghiệp hơn',
    ...
    aiEmptyBody1: 'Đưa ra chỉ dẫn hoặc chỉ cần đặt câu hỏi;',
    aiEmptyBody2: 'khi có văn bản được chọn, lệnh viết lại áp dụng cho vùng chọn.',
    aiStarterWeeklyReport: 'Viết báo cáo dự án hàng tuần giúp tôi',
    aiStarterLaunchPost: 'Soạn thông báo ra mắt sản phẩm',
    aiStarterEventOutline: 'Lập dàn ý kế hoạch sự kiện',
    ...
    aiScopeSelected: 'Đã chọn {count} đoạn văn',
    aiScopeEmptyDoc: 'Tài liệu trống',
    aiScopeCursor: 'Tại con trỏ',
    aiInputPlaceholder: 'Mô tả việc chỉnh sửa hoặc viết, hoặc đặt câu hỏi',
    ...
    aiRemoveAttachmentTitle: 'Xóa tệp đính kèm',
    aiTrackChanges: 'Theo dõi thay đổi',
    aiTrackOnTitle:
      'Đã bật theo dõi thay đổi: nội dung AI chỉnh sửa được đánh dấu là sửa đổi (gạch chân phần thêm, gạch ngang phần xóa); chấp nhận hoặc từ chối trong mục Xem xét',
    aiTrackOffTitle:
      'Đã tắt theo dõi thay đổi: chỉnh sửa của AI áp dụng ngay lập tức (vẫn có thể khôi phục qua ảnh chụp)',
    aiTurnLimit:
      'Tác vụ này đã tạm dừng trước khi hoàn tất mọi bước. Các chỉnh sửa đã hoàn thành được giữ nguyên; chọn Tiếp tục để hoàn tất phần còn lại.',
    aiStopped: '(Đã dừng)',
    aiNoReply: 'AI không trả về nội dung nào.',
    aiTruncatedNote: '(Phản hồi bị cắt do giới hạn độ dài và có thể chưa đầy đủ.)',
    aiImagesSendFailed:
      'Không đọc được tệp hình ảnh đính kèm; tin nhắn này đã gửi mà không có hình ảnh',
    aiImageReadFail: '{name}: đọc không thành công',
    aiTooManyImages: 'Tối đa {max} hình ảnh mỗi tin nhắn; các hình thừa đã bị bỏ qua',
    aiUnknownError: 'Lỗi không xác định',
    aiTimeoutError:
      'Yêu cầu AI hết thời gian chờ: không có phản hồi từ mạng nên tác vụ đã dừng. Kiểm tra kết nối và thử lại',
    aiCreditsExhausted:
    ...
    aiSumWebSearch: 'Tìm kiếm trên web',
    aiSumWebSearchDone: 'Đã tìm "{query}" ({count} kết quả)',
    aiSumImageSearch: 'Tìm kiếm hình ảnh',
    aiSumImageSearchDone: 'Tìm hình ảnh "{query}" ({count} hình)',
    aiSumInsertImage: 'Chèn hình ảnh',
    aiSumInsertWebImage: 'Đã chèn hình ảnh từ web',
    aiSumUnknownTool: 'Công cụ không xác định',
    aiSumReadDocContext: 'Đọc cấu trúc tài liệu',
    aiSumReadBlocks: 'Đọc khối',
    aiSumReadBlocksRange: 'Đọc khối {start}-{end}',
    aiSumInsertContent: 'Chèn nội dung',
    aiSumInsertedBlocks: 'Đã chèn {count} khối',
    aiSumReplaceContent: 'Thay thế nội dung',
    aiSumReplacedBlocks: 'Đã thay thế khối {start}-{end}',
    aiSumInsertChart: 'Chèn biểu đồ',
    aiSumInsertedChart: 'Đã chèn biểu đồ "{title}"',
    aiSumEditChart: 'Chỉnh sửa biểu đồ',
    aiSumEditedChart: 'Đã chỉnh sửa dữ liệu biểu đồ (khối {index})',
    aiSumApplyCommands: 'Áp dụng lệnh định dạng',
    aiCmdNone: 'Không có khối phù hợp; tài liệu không thay đổi.',
    aiCmdNoneSkipped:
      'Không có khối chỉnh sửa được; tài liệu không thay đổi (đã bỏ qua {count} khối được bảo vệ — bảng/hình ảnh không thể thay đổi bằng lệnh định dạng).',
    aiCmdTextStyle: 'Đã cập nhật kiểu chữ trên {count} khối',
    aiCmdParaStyle: 'Đã cập nhật định dạng đoạn văn trên {count} khối',
    aiCmdHeading: 'Đã điều chỉnh cấp tiêu đề trên {count} khối',
    aiCmdReplaceAll: '{detail} trên {count} khối',
    aiCmdReplacedCount: 'Đã thay thế {count} lần xuất hiện',
    aiCmdReplaceFallback: 'Đã thay thế văn bản',
