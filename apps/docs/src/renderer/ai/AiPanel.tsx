...
import { AideMark } from '../components/icons'
...
interface ChatEntry {
  ...
  undelivered?: boolean
  /** the run failed because Aide is signed out — render an inline sign-in button */
...
/** File-type icons for attachment cards (Aide attachment icon set); exts the
...
export function AiPanel({
  ...
  /** data-URL previews for image attachments, keyed by path (Aide composer thumbnails) */
